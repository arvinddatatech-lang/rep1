		...
		function filter_plugin_actions($links, $file) {
		   ...
		   return $links;
                ...
                function get_ajax_cart_qty(){
                    global $woocommerce;
                    echo wp_kses_post($woocommerce->cart->cart_contents_count);
			...
			<?php wp_nonce_field('wc_ajax_cart_quantity-update-options'); ?>
				<table width="100%" cellspacing="2" cellpadding="5" class="form-table"> 
					<tr valign="top"> 
						...
						<td>
							<input name="wc_ajax_cart_quantity_option1" type="text" id="wc_ajax_cart_quantity_option1" size="45" value="<?php echo wp_kses_post($this->options['wc_ajax_cart_quantity_option1']) ;?>"/>
					...
					<tr valign="top"> 
						...
						<td>
							<input name="wc_ajax_cart_quantity_option2" type="text" id="wc_ajax_cart_quantity_option2" size="45" value="<?php echo wp_kses_post($this->options['wc_ajax_cart_quantity_option2']);?>"/>
