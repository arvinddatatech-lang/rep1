...
class kitgreen_Widget_Attributes_Filter extends WC_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        ?> <div class="<?php echo wp_kses_post($taxonomy);  ?>"><?php 
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type, $show_color ) {
		...
		foreach ( $terms as $term ) {
			...
			echo wp_kses_post(( $count > 0 || $option_is_set ) ? '<a href="' . esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) . '">' : '<span>');
